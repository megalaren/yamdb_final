# Generated by Django 3.0.5 on 2021-05-13 11:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(2021), django.core.validators.MinValueValidator(0)], verbose_name='Год выпуска')),
                ('category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='titles', to='api.Category', verbose_name='Категория')),
